                 ...
                 <div class="search-block-v2" ng-app="purchaseOrderApp" ng-controller="purchaseOrderDetailControl">
                    <div class="container">
                        <div class="col-md-8 col-md-offset-2">
                            <br><h2 align="center">Cari Tutorial</h2><br>
                            <div class="input-group">
                                ...
                                <select name="subkategori_id" class="form-control" style="width: 30%">
                                    ...
                                    <?php foreach($subkategoris as $subkategori){ 
                                        $selected = "";
                                        if($subkategori->id==$subkategori_id) $selected='selected="selected"';
                                    ?>

                                    <option <?= $selected ?> value="<?php echo $subkategori->id; ?>"><?php echo $subkategori->nama; ?></option>
                                    <?php } ?>
                                </select>
                ...
                <?php
                    foreach($data as $row){
                        ...
                        <div class="inner-results">
                            ...
                            <p>
                                <?php 
                                    if(strlen($row->deskripsi) > 300){
                                        echo substr($row->deskripsi,0,300).'...';
                                    }else{
                                        echo $row->deskripsi; 
                                    } 
                                ?>
