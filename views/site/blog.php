            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 pull-right white-right right-side ptb-13">
                       <p>Menemukan sebanyak <?= $count ?> tulisan siswa</p>
                        <!-- .single-blog-post -->
                ...
                foreach($posts as $post){
                    echo '<div>';
                            ...
                            echo '<div class="content">';
                                ...
                                echo '<a href="'.\Yii::$app->urlManager->createUrl(['site/post-single', 'id' => $post->id]).'" class="read-more">Selengkapnya <i class="fa fa-angle-right"></i></a>';
                            echo '</div>';
