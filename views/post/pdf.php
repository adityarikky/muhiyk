    ...
    $posts = app\models\PdfPost::find()
            ...
            foreach ($posts as $nama) {
                 ...
                 $email = $nama->email;
                   ...
                   $query=app\models\PdfTutorial::findBySql("SELECT * FROM pdf_post");
                $total = $query->count();
            }
    }else{
        $posts = app\models\PdfPost::find()
            ...
            foreach ($posts as $nama) {
             ...
             $query=app\models\PdfPost::findBySql("SELECT * FROM pdf_post where user_id = ".Yii::$app->session->get('user.id')."");
                $total = $query->count();
