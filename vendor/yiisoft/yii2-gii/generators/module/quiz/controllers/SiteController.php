    ...
    public function actionFinish()
    {
        ...
        {            
            ...
            if(isset($_POST['DiplomaForm']))
            {
                ...
                {
                    require('../modules/quiz/lib/fpdf/fpdf.php');
                    $pdf = new \FPDF('L','mm','A4');
                    $pdf->SetDisplayMode('fullpage');
                    $pdf->SetTitle('Diploma for you');
                    $pdf->AddPage();
                    $pdf->Image('../modules/quiz/assets/images/marble.jpg',0,0,$pdf->w,$pdf->h);
                    $pdf->Image('../modules/quiz/assets/images/diploma-frame.gif',0,0,$pdf->w,$pdf->h);
